...
public class Puesto implements Serializable {
    ...
    public String toString() {
        return "Puesto{" + "id=" + id + ", nombre=" + nombre + ", area=" + area + ", descripcion=" + descripcion + ", requisitos=" + requisitos + ", horario=" + horario + ", nombre_empresa=" + nombre_empresa + ", locacion_empresa=" + locacion_empresa + ", vigente=" + vigente + '}';
    }
