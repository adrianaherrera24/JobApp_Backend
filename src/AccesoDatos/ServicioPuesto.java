...
public class ServicioPuesto extends AccesoServicios{
    ...
    private static final String listarPuestoEmpresa = "{?=call listarPuestoEmpresa (?)}";
    ...
    public List<Puesto> listarPuestoEmpresa(String id) throws GlobalException, NoDataException
    {
        ...
        try
        {
            pstmt = conexion.prepareCall(listarPuestoEmpresa);
            pstmt.registerOutParameter(1, OracleTypes.CURSOR);
            pstmt.setString(2, id);
    ...
    public boolean insertarPuesto(Puesto puesto) throws GlobalException, NoDataException
    {
        ...
        try
        {
            ...
            pstmt.setString(3, puesto.getEmpresa_id());
            pstmt.setString(4, puesto.getArea());
            pstmt.setString(5, puesto.getNombre());
            pstmt.setString(6, puesto.getDescripcion());
            pstmt.setString(7, puesto.getRequisitos());
            pstmt.setString(8, puesto.getHorario());
            pstmt.setInt(9, puesto.getVigente());            
            pstmt.execute();
